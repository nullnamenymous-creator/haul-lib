...
-- Data Berkas Arsip Media (Media Files)
insert into media_files (id, event_id, title, description, file_url, file_type, mime_type, file_size, download_count, created_at)
values 
  ('m1111111-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 'Dokumentasi Suasana Puncak Haul Akbar Ke-15', 'Lautan jamaah dan para habaib memadati pelataran utama majelis pada malam puncak khotmil Qur''an dan tahlil akbar.', 'https://images.unsplash.com/photo-1542810634-71277d95dcbb?w=1600&auto=format&fit=crop&q=85', 'photo', 'image/jpeg', 3450000, 247, '2024-05-18T10:00:00Z'),
  ('m2222222-2222-2222-2222-222222222222', 'b1111111-1111-1111-1111-111111111111', 'Video Dokumentasi Tausiyah Hikmah Haul Ke-15', 'Cuplikan tausiyah mendalam mengenai keteladanan akhlak dan sanad keilmuan Mu''alim Ahmad Shobandi dalam mendidik generasi.', 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', 'video', 'video/mp4', 15400000, 512, '2024-05-18T14:30:00Z'),
  ('m3333333-3333-3333-3333-333333333333', 'b1111111-1111-1111-1111-111111111111', 'Rekaman Audio Pembacaan Manaqib & Qasidah Burdah', 'Lantunan merdu bait-bait qasidah sanjungan baginda Rasulullah SAW dan riwayat manaqib perjuangan dakwah guru mulia.', 'https://actions.google.com/sounds/v1/ambiences/outdoor_water_fountain.ogg', 'audio', 'audio/ogg', 4890000, 830, '2024-05-18T16:00:00Z'),
  ('m4444444-4444-4444-4444-444444444444', 'b1111111-1111-1111-1111-111111111111', 'Buku Risalah Manaqib & Susunan Doa Haul Ke-15', 'Dokumen resmi panduan jamaah berisi silsilah, wirid ratibul haddad, serta biografi singkat shahibul haul dalam format PDF siap cetak.', '/sample-document.pdf', 'document', 'application/pdf', 1850000, 672, '2024-05-18T08:00:00Z'),
  ('m5555555-5555-5555-5555-555555555555', 'b2222222-2222-2222-2222-222222222222', 'Foto Bersejarah Peninggalan Kitab & Manuskrip', 'Koleksi manuskrip catatan tangan dan kajian kitab fiqih Mu''alim Ahmad Shobandi yang terawat baik.', 'https://images.unsplash.com/photo-1532012164546-f432f2e3777f?w=1600&auto=format&fit=crop&q=85', 'photo', 'image/jpeg', 2900000, 140, '2023-06-03T11:00:00Z'),
  ('m6666666-6666-6666-6666-666666666666', 'b3333333-3333-3333-3333-333333333333', 'Dokumentasi Lautan Jamaah Haul Solo Habib Ali Al-Habsyi', 'Pemandangan udara dan suasana jalan Kapten Mulyadi Pasar Kliwon Surakarta saat pembacaan Maulid Simtudduror.', 'https://images.unsplash.com/photo-1564769625905-50e93615e769?w=1600&auto=format&fit=crop&q=85', 'photo', 'image/jpeg', 4200000, 1105, '2023-11-04T12:00:00Z'),
  ('m7777777-7777-7777-7777-777777777777', 'b3333333-3333-3333-3333-333333333333', 'Audio Lantunan Maulid Simtudduror Lengkap', 'Rekaman audio jernih pembacaan fasal-fasal Maulid Habsyi bersama para habaib dan masyayikh di Masjid Riyadh Solo.', 'https://actions.google.com/sounds/v1/weather/light_rain.ogg', 'audio', 'audio/ogg', 8200000, 1540, '2023-11-04T15:00:00Z'),
  ('m8888888-8888-8888-8888-888888888888', 'b4444444-4444-4444-4444-444444444444', 'Video Rekaman Suasana Dzikir Bersama Haul Sekumpul', 'Momen khusyuk lantunan tahlil dan doa bersama jutaan jamaah di Kompleks Rawdha Martapura.', 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/WeAreGoingOnBullrun.mp4', 'video', 'video/mp4', 19800000, 980, '2024-01-14T20:00:00Z'),
  ('m9999999-9999-9999-9999-999999999999', 'b4444444-4444-4444-4444-444444444444', 'Panduan Rute & Jadwal Acara Haul Akbar', 'Brosur panduan jalur transportasi, titik wudhu, posko kesehatan, dan tata tertib jamaah.', '/sample-document.pdf', 'document', 'application/pdf', 1240000, 430, '2024-01-14T07:00:00Z')
on conflict (id) do update set
  title = excluded.title,
